                ...
                <form role="form" action="{{URL::to('/postupdateproduct')}}" method="post">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="txt-name" name="name" placeholder="">

                        </div>

                        <div class="form-group">
                            <label for="txt-id">Id Loại Đàn</label>
                            <input type="text" class="form-control" id="txt-id" name="id_type" placeholder="">
                        </div>
