...
class AdminController extends Controller
{
    ...
    {
        return view('admin_product.dashboard');
    }
    ...
    public function show_product()
    {
        ...
        return view('admin_product.product')->with(['products' => $products]);
    }
    //add products
    public function add_product()
    {
        return view('admin_product.add_product');
    }
    ...
    public function update_product($id)
    {
        $products = DB::table('products')
            ->where('id', intval($id))
            ->first();
        return view('admin_product.update_product', ['products' => $products]);
    }
    ...
    //show bang thong tin loai san pham
    public function show_type_product()
    {
        $type_product = DB::table('type_products')->get();
        return view('admin_product.type_product',compact('type_product'));
    }
}
